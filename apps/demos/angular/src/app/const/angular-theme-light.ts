import { lightTheme, KritzelTheme } from "@kritzel/angular-editor";
...
export const angularThemeLight: KritzelTheme = {
  ...
  button: {
    ...
    primaryHoverBackgroundColor: '#b70028',
    primaryActiveBackgroundColor: '#9f0023',
    primaryColor: '#ffffff',
  },
  currentUserDialog: {
    ...lightTheme.currentUserDialog,
    logoutButtonBackgroundColor: '#dd0031',
    logoutButtonHoverBackgroundColor: '#b70028',
    logoutButtonActiveBackgroundColor: '#9f0023',
